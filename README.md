<div align="center">
  ...
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0D1117&height=220&section=header&text=XploitVoid&fontSize=90&fontAlignY=30&desc=Automation%20%7C%20Networking%20%7C%20Optimization&descAlignY=70&descSize=20&fontColor=00ff00" />
...
```bash
$ cat /etc/motd
> Currently shipping: Win11 Net Automator
> Preferred interface: terminal
> Status: building
```
...
**[Win11 Net Automator](https://github.com/XploitVoid/win11-net-automator)**  
The ultimate Windows networking suite — automated, optimized, and built for power users.
